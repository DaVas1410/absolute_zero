...
class FallbackChatModel:
    ...
    def with_structured_output(self, schema, include_raw: bool = False):
        try:
            primary_structured = self._primary.with_structured_output(schema, include_raw=include_raw)
        except Exception:
            primary_structured = None

        fallback_structured = self._fallback.with_structured_output(schema, include_raw=include_raw)
